...
```python
Image(p+'/exampleOfPigMovement.gif',width=300,height=100)
```
...
```python
Image(p+'/output01.gif',width=300,height=100)
```
...
```python
Image(p+'/output02.gif',width=300,height=100)
```
...
![png](capturing_files/capturing_19_0.png)
